...
public class MenuPage extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        number = i.getIntExtra("number",number);
        name = i.getStringExtra("name");                    //name의 값을 가지고와서 name에 저장
        group = i.getStringExtra("group");                  //group의 값을 가지고와서 group에 저장
        tel = i.getStringExtra("tel");                      //tel의 값을 가지고 와서 tel에 저장
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent BM_intent = new Intent(MenuPage.this,MainPage.class);
